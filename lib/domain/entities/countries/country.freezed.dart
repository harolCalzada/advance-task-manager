...
abstract mixin class $CountryCopyWith<$Res> {
  ...
  @useResult
  $Res call({String code, String name, String emoji});
}
...
extension CountryPatterns on Country {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String code, String name, String emoji)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _Country implements Country {
  const _Country({required this.code, required this.name, required this.emoji});
